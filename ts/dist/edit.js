...
const Form = cc("form", {
    children: [
        ...
        util.create_item(CatInput, "Category", "类型（暂存/永久），可在消息列表中点击 toggle 按钮转换类型。"),
        util.create_item(AliasInput, "Alias", "别名(可留空)。用于方便命令行精准指定消息。"),
...
function loadData() {
    util.ajax({ method: "POST", url: "/api/get-by-id", alerts: Alerts, body: { id: id } }, (resp) => {
        tm = resp;
        Form.show();
