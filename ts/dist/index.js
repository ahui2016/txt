...
$("#root").append(titleArea, m(NaviBar).addClass("my-5"), m(Loading).addClass("my-5"), m(Alerts), m(GotoSignIn).addClass("my-3").hide(), m(Form).hide(), m(MsgList).addClass("mb-5"), footerElem.hide(), m(TextForCopy).hide());
init();
function init() {
    checkSignIn();
}
